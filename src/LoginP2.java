...
class Task {
   ...
   //initialize the count to 0
       ...
       //this will make the option 1 loop for the amount of tasks that user entered 
        for (int i = 0; i < numTasks; i++) {
           ...
           if (!checkTaskDescription(taskDescription)) {
               //check if the task description is less that 50 characters long
               //error message to be displayed if the task description is more than 50 characters long
                JOptionPane.showMessageDialog(null, "Please enter a task description of less than 50 characters");
                //user will be given another chance to enter task description instead of restarting the whole process
                JOptionPane.showInputDialog("Enter Task Description (max 50 characters):");
                  if (!checkTaskDescription(taskDescription)) {
                  
                 }else{
               //message to be displayed if the task description is less than 50 characters 
    ...
    //displays the total amount of hours
    }
        public static void showReport() {
        //message to be displayed when option 2 is selected
